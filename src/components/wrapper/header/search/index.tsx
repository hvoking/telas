...
// Context imports
import { useMapboxProperties } from '../../../main/context/maps/mapbox';
import { useMapboxSearchApi } from '../../../main/context/maps/mapbox/search';
import { useIsoPolygonApi } from '../../../main/context/api/isoPolygon';
	...
	return (
		<div className="auto-complete">
			<img 
				...
				src="static/yu_header/search_icon.svg" 
				alt="search-icon"
				...
				<>
					...
					<div className="cancel-cross-wrapper">
						<img
							...
							src="static/yu_header/cancel_search.svg" 
							alt="search-icon"
